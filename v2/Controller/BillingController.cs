...
public class BillingController : ControllerBase
{
    ...
    [HttpGet("invoices/monthly")]
    public async Task<IActionResult> GetMyMonthlyInvoices(
    [FromQuery] int year,
    [FromQuery] int month)
    {
        var identityUserId = User.FindFirstValue(ClaimTypes.NameIdentifier);
        ...
        var (statusCode, message) =
            await _billingService.GetMyMonthlyInvoiceHistoryAsync(
                year, month, identityUserId);
